...
const config = {
    apiKey: "AIzaSyBZXAk3NHVGYgcvZaKuGucN-cAfemgxgGQ",
    authDomain: "tictactoe-5b550.firebaseapp.com",
    databaseURL: "https://tictactoe-5b550.firebaseio.com",
    projectId: "tictactoe-5b550",
    storageBucket: "tictactoe-5b550.appspot.com",
    messagingSenderId: "652592276417"
  };
...
angular.module('gameApp', ['ngRoute', 'firebase'])
    ...
    .controller('GameController', ['$routeParams','$location','$scope','$interpolate','$firebaseObject',function($routeParams, $location,$scope,$interpolate,$firebaseObject){
        this.message = 'Hello from Deeksha!!!!'
        ...
        $scope.boxClicked = function(x,y){
            ...
            console.log("Turn "+$scope.turnRef+" chi ahe. & route Params "+$routeParams.player);
